...
z <- pbivnorm(tau1[S[,1]],tau2[S[,2]], rho = rho) #GIVES NaN at some combinations!! So is a source of error.
pCopula(cbind(x1,x2), norm.cop)
...
#Works for most other trials of u,v combinations.
#Could it be a numerical approximation error?
#Let's use the same computation technique for computing P as we do in the simplified calculation.